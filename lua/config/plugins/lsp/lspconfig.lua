return {
  ...
  config = function()
    ...
    local on_attach = function(client, bufnr)
      ...
      keymap.set("n", "<leader>cd", "<cmd>Telescope lsp_definitios<cr>", opts) -- show lsp definitions

      opts.desc = "Show LSP implementations"
      keymap.set("n", "<leader>ci", "<cmd>Telescope lsp_implementations<cr>", opts) -- show lsp implementations

      opts.desc = "Show LSP type definitions"
      keymap.set("n", "<leader>ct", "<cmd>Telescope lsp_type_definitios<cr>", opts) -- show lsp type definitions
